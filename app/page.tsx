...
export default function LandingPage() {
  useEffect(() => {
    // Cursor
    const c1 = document.getElementById('c1') as HTMLElement | null
    const c2 = document.getElementById('c2') as HTMLElement | null
    let mx = window.innerWidth / 2, my = window.innerHeight / 2, rx = mx, ry = my
    const onMove = (e: MouseEvent) => { mx = e.clientX; my = e.clientY }
    const onLeave = () => { if (c1) c1.style.opacity = '0'; if (c2) c2.style.opacity = '0' }
    const onEnter = () => { if (c1) c1.style.opacity = '1'; if (c2) c2.style.opacity = '1' }
    ...
    const cursorLoop = () => {
      ...
      if (c1) { c1.style.left = mx + 'px'; c1.style.top = my + 'px' }
      if (c2) { c2.style.left = rx + 'px'; c2.style.top = ry + 'px' }
    ...
    return () => {
      ...
      obs.disconnect()
      const pos = document.getElementById('fp-pos')
      const neg = document.getElementById('fp-neg')
      if (pos) pos.innerHTML = ''
      if (neg) neg.innerHTML = ''
    }
  }, [])

  const ck = <svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2"><path d="M2 8l5 5 7-7"/></svg>
  const xk = <svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 3l10 10M13 3L3 13"/></svg>
    ...
    <>
        ...
        <div className="showcase">
          <div className="mock-frame">
            ...
            <div className="mock-bar">
              ...
              <span className="mock-url">stagepay.co.bw/invoice/INV-055</span>
            </div>
            <div className="mock-body">
              ...
              <div className="mock-total">
                ...
                <span className="mock-total-val">P52,440</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="ticker">
        <div className="ticker-track">
          <div className="tick-item"><strong>Botswana</strong> 14% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>South Africa</strong> 15% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Kenya</strong> 16% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Nigeria</strong> 7.5% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>UAE</strong> 5% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>United Kingdom</strong> 20% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Germany</strong> 19% MwSt &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Australia</strong> 10% GST &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>India</strong> 18% GST &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Singapore</strong> 9% GST &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Canada</strong> 5% GST &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Zambia</strong> 16% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Namibia</strong> 15% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Botswana</strong> 14% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>South Africa</strong> 15% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Kenya</strong> 16% VAT &nbsp;·&nbsp;</div>
          <div className="tick-item"><strong>Nigeria</strong> 7.5% VAT &nbsp;·&nbsp;</div>
        ...
        <div className="sec-inner">
          ...
          <div className="feat-grid r">
            <div className="feat-card">
              ...
              <div className="feat-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="1.8"><path d="M12 2l-2 7H3l6 4-2 7 5-4 5 4-2-7 6-4h-7z"/></svg></div>
            ...
            <div className="feat-card">
              ...
              <div className="feat-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="1.8"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg></div>
              ...
              <span className="feat-tag wa-tag">WhatsApp</span>
            </div>
            <div className="feat-card">
              <div className="feat-num">03</div>
              <div className="feat-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="1.8"><path d="M3 12l9-9 9 9"/><path d="M9 21V9h6v12"/></svg></div>
            ...
            <div className="feat-card">
              ...
              <div className="feat-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="1.8"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M8 4v16M2 9h6"/></svg></div>
            ...
            <div className="feat-card">
              ...
              <div className="feat-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="1.8"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6"/></svg></div>
            ...
            <div className="feat-card">
              ...
              <div className="feat-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="1.8"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5M2 12l10 5 10-5"/></svg></div>
          ...
          <div className="price-grid r">
            ...
            <div className="price-card pop">
              ...
              <div className="price-list">
                ...
                <div className="pf">{ck}Unlimited AI</div>
                <div className="pf">{ck}Auto reminders</div>
                <div className="pf">{ck}WhatsApp</div>
                <div className="pf">{ck}Deposit &amp; T&amp;C</div>
            ...
            <div className="price-card">
              ...
              <div className="price-list">
                ...
                <div className="pf">{ck}Analytics</div>
        ...
        <div className="sec-inner">
          ...
          <div className="testi-grid r">
            <div className="testi-card">
              ...
              <p className="testi-quote">&ldquo;I used to spend an hour per invoice. Now I describe the job, <em>hit Generate</em>, and it&apos;s done in seconds.&rdquo;</p>
            ...
            <div className="testi-card">
              <div className="testi-stars">★★★★★</div>
              <p className="testi-quote">&ldquo;The <em>WhatsApp reminders</em> changed everything. Clients respond 10x faster than email. Payments arrive within days.&rdquo;</p>
              <div className="testi-author">
            ...
            <div className="testi-card">
              <div className="testi-stars">★★★★★</div>
              <p className="testi-quote">&ldquo;<em>Deposit billing</em> alone paid for the subscription. Clients pay 50% upfront now — no more chasing for months.&rdquo;</p>
              <div className="testi-author">
                <div className="testi-av" style={{background:'rgba(245,158,11,.12)',color:'#F59E0B'}}>LK</div>
                <div><div className="testi-name">Lerato Kgosi</div><div className="testi-role">Consulting, Johannesburg</div></div>
              </div>
            </div>
          </div>
        </div>
