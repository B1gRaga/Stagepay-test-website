                  ...
                  {(c.phone || c.address) && (
                    <div className="card-footer">
                      {c.phone && (
                        ...
                        >
                          <svg width="10" height="10" viewBox="0 0 16 16" fill="#25D366"><path d="M8 0C3.58 0 0 3.58 0 8c0 1.41.37 2.74 1.02 3.89L0 16l4.25-1.11A7.94 7.94 0 008 16c4.42 0 8-3.58 8-8s-3.58-8-8-8z"/></svg>
                          {c.phone}
                        </a>
                      )}
                      {c.address && (
                ...
                <div key={c.id} className="list-row">
                  ...
                  <div>
                    {c.phone && (
                      ...
                      >
                        <svg width="13" height="13" viewBox="0 0 16 16" fill="#25D366"><path d="M8 0C3.58 0 0 3.58 0 8c0 1.41.37 2.74 1.02 3.89L0 16l4.25-1.11A7.94 7.94 0 008 16c4.42 0 8-3.58 8-8s-3.58-8-8-8z"/></svg>
                      </a>
                    )}
                  </div>
                </div>
