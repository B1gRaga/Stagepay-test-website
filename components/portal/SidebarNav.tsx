...
const CSS = `
  ...
  @media(max-width:768px){
    ...
    html[data-theme="light"] .mob-topbar{background:#f0e9db;border-bottom-color:rgba(26,26,26,0.08);}
    ...
    html[data-theme="light"] .sidebar{background:#f0e9db;border-top-color:rgba(26,26,26,0.10);}
