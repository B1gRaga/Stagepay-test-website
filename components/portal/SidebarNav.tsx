...
const CSS = `
  ...
  @media(max-width:768px){
    ...
    html[data-theme="light"] .mob-topbar{background:rgba(255,255,255,0.98);border-bottom-color:rgba(26,26,26,0.08);}
    ...
    html[data-theme="light"] .mob-tab svg{stroke:rgba(15,23,42,.38);}
